# Mouthfeel for Antigravity

Version 0.9.0. Temporary output styles for coding agents. Requires Node.js >=22.19.0.

Use `/mouthfeel sailor 2` to activate a profile for future replies.
Use `/mouthfeel list` to browse profiles, `/mouthfeel untranslate`
to rewrite just the previous styled reply, or `/mouthfeel off` to disable it.
